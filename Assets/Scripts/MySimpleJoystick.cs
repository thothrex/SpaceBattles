...
namespace SpaceBattles
{
    ...
    /// A very slightly modified version of CnControls.SimpleJoystick
    /// </summary>
    public class MySimpleJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
    {
        /// <summary>
        ...
        /// <summary>
        /// The name of the axis to use for detecting when the joystick
        /// is depressed
        /// </summary>
        public string JoystickDepressedAxisName = "JoystickDepressed";
        ...
        protected VirtualAxis JoystickDepressedAxis;
        ...
        {
            // When we enable, we get our virtual axes
            HorizontalAxis
                = HorizontalAxis
                ?? new VirtualAxis(HorizontalAxisName);
            VerticalAxis
                = VerticalAxis
                ?? new VirtualAxis(VerticalAxisName);
            JoystickDepressedAxis 
                = JoystickDepressedAxis
                ?? new VirtualAxis(JoystickDepressedAxisName);
            ...
            CnInputManager.RegisterVirtualAxis(JoystickDepressedAxis);
        }
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            JoystickDepressedAxis.Value = 1.0f;
            Debug.Log("receiving input is true");
        }
