...
namespace SpaceBattles
{
    public abstract class GameplayInputAdapterModule
    {
        ...
        protected static readonly string OrreryOrbitStartRotationButtonName = "mouse 1";
        protected static readonly string OrreryOrbitRotationXAxisName = "OrreryXRotation";

        private readonly float FullRotationAngle = 360.0f;
        private bool InMouseDrag = false;
        private Vector2 MouseDragStart = new Vector2(0,0);
